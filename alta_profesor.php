...
/*alta_alumno.php
 * recibe los datos de for_profesor.php, los procesa e inserta en la BD
 * author: OscarMau
 * date 18 03 2021
 */
//print_r($_POST);
...
//if($con){
	...
	//genera la consulta
	$query = "insert into profesores (nombre_profesor,apaterno_profesor,amaterno_profesor,tel_profesor,correo_profesor) values('".$nombre." ',' ".$apaterno." ',' ".$amaterno." ',' ".$telefono." ',' ".$correoe."')";
	$query = pg_query($con,$query) or die (pg_last_error());
	if($query){
		echo "<p>Se guardo el registro del profesor</p>";
