...
if($con){
	...
	//genera la consulta
	$query = "update alumnos set nombre_alumno ='".$nombre."' ,apaterno_alumno = '".$apaterno."' ,amaterno_alumno ='".$amaterno."' ,tel_alumno ='".$telefono."' ,correo_alumno = '".$correoe."' where id_alumno=".$id;
